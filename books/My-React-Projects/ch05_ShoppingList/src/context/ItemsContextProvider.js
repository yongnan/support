...
const ItemsContextProvider = ({ children }) => {
    ...
    const getItemsRequest = async (id) => {
        const result = await fetchData(
            `https://my-json-server.typicode.com/PacktPublishing/React-Projects/lists/${id}/items`, );
    ...
    const addItemRequest = async (content) => {
        const result = await postData(
            `https://my-json-server.typicode.com/PacktPublishing/React-Projects/lists`, content, );

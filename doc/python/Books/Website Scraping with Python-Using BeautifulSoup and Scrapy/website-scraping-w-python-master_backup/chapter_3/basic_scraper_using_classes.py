...
downloader = Downloader(hard_cache=False)
...
if __name__ == '__main__':
    ...
    product_pages = extract_links_to_product_pages(department_links[:2])
    print(len(product_pages), 'product pages found')

    product_details = extract_product_details(product_pages[:2])
    # print(len(product_details), 'product details found')
    # print(len(set(product_details)), 'distinct product details found')

    product_information = extract_product_information(product_details[:5])
    # csv_file = 'sainsburys2.csv'
    # write_results_to_csv(csv_file, product_information)
    # json_file = 'sainsburys.json'
    # write_results_to_json(json_file, product_information)

...
exports.findAllItems = async (res) => {
    try{
...
exports.findItemById = async (gfs, req, res) => {
    try {
...
exports.findItemsByAttribute = async (key, value, res) => {
    try{
        var filter = {};
        filter[key] = value;
...
exports.findItemsByCategory = async (category, res) => {
    try{
...
exports.saveImage = async (gfs, mongodb, req, res) => {
    try{
...
exports.getImage = async (gfs, mongodb, req, res) =>{
    readImage(gfs, mongodb, req, res);
};
...
exports.deleteImage = function(gfs, mongodb, itemId, res) {

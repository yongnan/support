...
```
touch app/routes/jokes\[.\]rss.tsx
```
...
```sh
mkdir -p app/components && touch app/components/joke.tsx
```

new file: `app/components/joke.tsx`
...
-        <p>Here's your hilarious joke:</p>
-        <p>{data.joke.content}</p>
-        <Link to="." prefetch="intent">{data.joke.name} Permalink</Link>
-        {data.isOwner ? (
-          <Form method="post">
-            <button
-              className="button"
